  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-5xl flex-col items-center gap-12 md:flex-row">
        ...
        >
          <div className="flex h-full w-full items-center justify-center rounded-full border-2 border-amber/30 bg-evergreen/50">
            <span className="font-heading text-5xl text-amber md:text-6xl">
        ...
        <div ref={textRef} className="opacity-0" style={{ transform: 'translateY(30px)' }}>
          ...
          <p className="mt-6 font-body text-base leading-relaxed text-frost/70 md:text-lg">
            {personalData.bio}
          </p>
          <div className="mt-6 flex items-center gap-4">
            <a
              ...
              className="group inline-flex items-center gap-2 rounded-full border border-amber/40 px-6 py-2 font-body text-sm text-amber transition-all duration-300 hover:bg-amber/10"
            >
              LinkedIn
